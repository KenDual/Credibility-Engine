...
# ============================================================================
# 6b. INTERACTION & SEASONAL FEATURES
# ============================================================================
df['Price_x_Quantity'] = df['Product_Price'] * df['Order_Quantity']
df['Discount_x_Age'] = df['Discount_Percentage'] * df['User_Age']
df['Category_Price_Interaction'] = df['Product_Category_Encoded'] * df['Product_Price']

# Binning chi tiết hơn
df['Ultra_High_Price'] = (df['Product_Price'] > 500).astype(int)
df['Impulse_Buy'] = ((df['Discount_Percentage'] > 45) & (df['Product_Price'] < 100)).astype(int)
...
feature_columns = [
    ...
    # >>> NEW: interaction/binning/seasonal features (7)
    'Price_x_Quantity',
    'Discount_x_Age',
    'Category_Price_Interaction',
    'Ultra_High_Price',
    'Impulse_Buy',
    'Is_Holiday_Season',
    'Is_Summer'
...
numerical_to_scale = [
    ...
    # >>> NEW: scale các tương tác có giá trị liên tục
    'Price_x_Quantity',
    'Discount_x_Age',
    'Category_Price_Interaction'
]
